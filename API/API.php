...
/**
 * Class API will act as a wrapper for all of the custom endpoints that our API will be using.
 ...
 * Once that's done, the abstract class will pass the request information on to a method in the concrete class to
...
abstract class API {
    ...
    /**
     * Property: file
     * Stores the input of the request
     */
    protected $file = Null;
    ...
    /**
     * This method determine if the concrete class implements a method for the endpoint that the client requested.
